...
public class LlmExecutionService {
    ...
    public LlmCallResult callLLM(String systemPrompt, String question, String context) {
    ...
    public LlmCallResult callLLM(String question, String context) {
        String systemPrompt = """
                ...
                5. Tối đa 300 từ.
                """;
        return callLLM(systemPrompt, question, context);
    }

    public LlmCallResult callGeminiFallback(String systemPrompt, String question, String context, Exception e) {

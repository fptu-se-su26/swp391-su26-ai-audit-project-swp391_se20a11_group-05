    ...
    return (
      <section className="mx-auto max-w-2xl rounded-2xl border border-slate-100 bg-white p-8 shadow-md text-left">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-600">
          Chỉ có cán bộ địa phương phụ trách được cấp quyền tạo các chiến dịch cộng đồng mới. Người
          dân có thể đăng ký tham gia các chiến dịch khi đã được phê duyệt chính thức.
        </p>
        <Link
          to="/ward"
          search={{ tab: "campaign" }}

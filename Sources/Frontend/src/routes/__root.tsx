  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4 animate-fade-in-up">
      <div className="max-w-md text-center">
        <div className="text-8xl md:text-9xl font-heading text-gov-blue/10 font-black leading-none mb-4">
          404
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Đà Nẵng Kết Nối — Cổng phản ánh chính quyền thành phố" },
      {
        ...
        content:
          "City Watch connects citizens to authorities for real-time urban issue reporting via a user-friendly platform.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/162c94dc-834f-43a8-bfc1-706a25cf41f4/id-preview-212192de--7df13921-d23d-44dd-96f0-6d5387b73bd7.lovable.app-1778900365683.png",
      },
      {
        name: "twitter:image",
        content:

...
const MOCK_NEWS = [
  ...
  },
  {
    ...
    summary:
      "Hàng trăm tập đoàn, doanh nghiệp công nghệ lớn trong và ngoài nước đã quy tụ tại hội nghị xúc tiến đầu tư, mở ra nhiều cơ hội hợp tác chiến lược.",
    content:
      "<p>Trong khuôn khổ chuỗi sự kiện chuyển đổi số, Hội nghị Xúc tiến đầu tư phát triển công nghệ cao 2026 đã diễn ra thành công tốt đẹp. Hội nghị tập trung thảo luận về các chính sách ưu đãi đầu tư mới, hạ tầng công nghệ thông tin và nguồn nhân lực chất lượng cao.</p><p>Tại sự kiện, 5 biên bản ghi nhớ hợp tác (MOU) đã được ký kết với các đối tác chiến lược về phát triển trung tâm dữ liệu (Data Center) và phòng thí nghiệm trí tuệ nhân tạo (AI Lab) tại khu công nghệ cao của thành phố.</p><p>Sự kiện này đánh dấu bước tiến quan trọng trong nỗ lực đưa thành phố trở thành trung tâm công nghệ và đổi mới sáng tạo hàng đầu khu vực.</p>",

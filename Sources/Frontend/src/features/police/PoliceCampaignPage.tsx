...
import { CalendarDays, Flag, Users, Plus, Eye, CheckCircle2, Clock3, Pencil } from "lucide-react";
              ...
              {campaigns.length > 0 ? (
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        {(() => {
                          ...
                          return (
                            <span
                              className={`inline-flex items-center gap-1 rounded-full border px-2.5 py-0.5 text-[11px] font-extrabold ${isClosed ? "bg-slate-50 text-slate-600 border-slate-200" : isFull ? "bg-red-50 text-red-700 border-red-200" : "bg-emerald-50 text-emerald-700 border-emerald-200"}`}
                            >
                              {isClosed
                                ? "Đã đóng"
                ...
                <tr>
                  <td colSpan={6} className="px-5 py-8 text-center text-slate-400 text-sm">
                    Chưa có chiến dịch nào được phát động.
                  </td>
                </tr>
              )}
            </tbody>

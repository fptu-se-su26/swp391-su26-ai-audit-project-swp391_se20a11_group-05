  ...
  return (
    <main className="min-h-screen bg-[#F8F7FF] pb-16 text-slate-950">
      <div className="mx-auto max-w-[1280px] px-4 py-8 sm:px-6 lg:px-8">
        <section className="relative mb-10 overflow-hidden rounded-[28px] p-8 shadow-2xl md:p-12 min-h-[440px] flex items-center border border-white/10">
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[45%_55%] items-center w-full">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <h1 className="mt-5 text-4xl sm:text-5xl font-black tracking-tight text-white leading-[1.15]">
                ...
                <span className="bg-gradient-to-r from-violet-200 via-indigo-100 to-white bg-clip-text text-transparent">
                  cộng đồng
                </span>
              </h1>

              <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-300 font-medium">
                Xem các chiến dịch đã được phê duyệt, đăng ký tham gia và theo dõi tiến độ cải thiện
                đô thị tại địa phương của bạn.
              </p>
        ...
        {isAuthenticated && user?.campaignBanned && (
          <div className="mb-6 rounded-2xl border border-rose-200 bg-rose-50/50 p-5 shadow-md text-rose-800 dark:bg-rose-950/10 dark:border-rose-900/30 flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-fade-in">
            <div className="flex items-start gap-3.5">
              <div className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-rose-100 text-rose-700 dark:bg-rose-950 dark:text-rose-400">
                <AlertTriangle className="h-5.5 w-5.5 animate-pulse" />
              </div>
              <div>
                <h4 className="text-sm font-black uppercase tracking-wider text-rose-750">
                  Quyền tham gia chiến dịch đang bị khóa
                </h4>
                <p className="text-xs mt-1 leading-normal font-semibold text-rose-800/80">
                  Tài khoản của bạn đã bị tạm dừng đăng ký tham gia các chiến dịch cộng đồng mới do vắng mặt không lý do. Vui lòng gửi đơn giải trình để được mở khóa.
                </p>
              </div>
            </div>
            <button
              onClick={() => setShowAppealModal(true)}
              className="shrink-0 flex items-center justify-center gap-1.5 bg-rose-600 hover:bg-rose-700 text-white font-bold py-2.5 px-4 rounded-xl text-xs transition-all duration-200 cursor-pointer shadow-md shadow-rose-600/15 hover:scale-[1.02]"
            >
    ...
    <div className="w-full h-full flex items-center justify-center">
      <svg viewBox="0 0 500 360" className="w-full h-full max-w-[460px] drop-shadow-2xl">
        ...
        <g transform="translate(60, 160)">
          {/* Plant/Sapling */}
          <path
            d="M80 140 Q80 110 85 90 T95 60"
            fill="none"
            stroke="#34D399"
            strokeWidth="4"
            strokeLinecap="round"
          ...
          {/* Legs/knees */}
          <path
            d="M25 140 Q35 125 50 125 T70 140"
            fill="none"
            stroke="#818CF8"
            strokeWidth="10"
            strokeLinecap="round"
          ...
          {/* Torso */}
          <path
            d="M35 125 Q25 90 40 80 T65 110"
            fill="none"
            stroke="#E0E7FF"
            strokeWidth="16"
            strokeLinecap="round"
        ...
        <g transform="translate(240, 120)">
          ...
          {/* Legs */}
          <path
            d="M40 180 L45 140 M60 180 L55 140"
            stroke="#475569"
            strokeWidth="8"
            strokeLinecap="round"
          />
          ...
          {/* Arm holding tool */}
          <path
            d="M45 95 C30 100, 25 115, 20 120"
            fill="none"
            stroke="#FED7AA"
            strokeWidth="6"
            strokeLinecap="round"
        ...
        <g transform="translate(150, 100)">
          {/* Legs */}
          <path
            d="M45 200 L45 155 M60 200 L60 155"
            stroke="#312E81"
            strokeWidth="8"
            strokeLinecap="round"
          />
          ...
          <rect
            ...
            strokeWidth="2"
          />
          <path d="M52 125 C47 125, 47 132, 52 132 C57 132, 57 125, 52 125" fill="#EF4444" />{" "}
          {/* Heart symbol on box */}
          {/* Arms holding box */}
          <path
            d="M38 100 Q25 110 32 130"
            fill="none"
            stroke="#FDBA74"
            strokeWidth="6"
            strokeLinecap="round"

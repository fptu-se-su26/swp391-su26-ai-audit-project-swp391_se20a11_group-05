...
type WardSection = "overview" | "feedback" | "campaign" | "news" | "statistics" | "schedule" | "config";
...
export function WardDashboard() {
  ...
  const activeSection = (
    tab && (["overview", "feedback", "campaign", "news", "statistics", "schedule", "config"].includes(tab) || tab.startsWith("campaign/"))
